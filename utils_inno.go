...
func loadFactory(context *cli.Context) (libcontainer.Factory, error) {
	...
	intelRdtManager := libcontainer.InnoRdtFs
...
func (r *runner) run(config *specs.Process) (int, error) {
	...
	tty, err := setupIO(process, 0, 0, config.Terminal, detach, r.consoleSocket)
	if err != nil {
		return -1, err
	}
	defer tty.Close()
...
func startContainer(context *cli.Context, action CtAct) (int, error) {
